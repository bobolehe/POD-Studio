...
p=r.parent/'listing.html';s=p.read_text('utf8').replace('基于现有英国站 WALL_ART 模板','按所选英国 / 加拿大单站 WALL_ART 模板').replace('<h2>1. 素材与商品文案</h2>','<h2>1. 素材与商品文案</h2><label>目标站点<select id="market"><option value="UK">英国 · GBP · 单站模板</option><option value="CA">加拿大 · CAD · 单站模板</option></select></label>')
...
p=r.parent/'listing.js';s=p.read_text('utf8').replace("const data={product:","const data={market:$('market').value,product:")
